...
模型规则见 `docs/`，v0.1 车身技能与 exact 比例算法见 `docs/body-skill-options-v0.1.md`，v0.2 双输入与伤害区间见 `docs/ui-v0.2.md`，v0.3 射手车头规则见 `docs/head-hero-system.md`，发布前检查见 `docs/RELEASE-CHECKLIST.md`。
