...
- 车头：赫克托、弗林特、米娅、阿隆索、格温、布拉德利、亨德里克、布兰琪、鲁弗斯已结构化。弗林特为2代盾兵车头，三个5级常驻技能分别为盾兵伤害+100%、全军攻击+25%、全军穿透+25%。格温第6次攻击100% extraDamage及第8次攻击15% vulnerable replace均已 supported。
...
当前完整 catalog 共 59 个技能记录：55 supported、4 pending、0 unsupported。结构化效果为 56 supported、0 pending、0 unsupported。pending 分类为 RULE_UNKNOWN 0、ENGINE_GAP 0、DATA_SOURCE_UNCERTAIN 4。明细见 pending-skill-audit.md。
