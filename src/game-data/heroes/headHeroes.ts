...
function miaVulnerableSkill(id:string):Skill{return{id,name:"厄运缠身（5级）",status:"supported",trigger:{...probability(.5),attemptsPerRound:3,durationRounds:1},lifecycle:{durationRounds:1,activationTiming:"nextRound",refreshMode:"refresh"},effects:[{type:"vulnerable",value:.5,targetTroop:"all"}]}}
