...
export const marksmanFireCrystalSkills={
  ...
  "troop-skill.marksman.blazing-star": supported("troop-skill.marksman.blazing-star","炽火凝星 L24","L24：round1-5为0，round6-10射手基础增伤+12%；不是战斗叠层。","L24",triggerAlways,[{...effect("effect.marksman.blazing-star","baseDamageIncrease",.12,triggerAlways),activeRounds:[6,7,8,9,10]}]),
